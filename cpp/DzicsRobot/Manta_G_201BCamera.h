...
#ifndef MANTA_G_201BCAMERA_H
#define MANTA_G_201BCAMERA_H

#include "VimbaCPP/Include/VimbaCPP.h"

class Manta_G_201BCamera : public AVT::VmbAPI::Camera
{
    public:

        typedef SP_DECL( Manta_G_201BCamera ) Ptr;
        ...
        VmbErrorType LUTLoad ();
        VmbErrorType GetLUTLoadFeature (AVT::VmbAPI::FeaturePtr & feature);
        ...
        VmbErrorType LUTSave ();
        VmbErrorType GetLUTSaveFeature (AVT::VmbAPI::FeaturePtr & feature);
    ...
    private:
        ...
        AVT::VmbAPI::FeaturePtr m_LUTLoadFeature;
        AVT::VmbAPI::FeaturePtr m_LUTModeFeature;
        AVT::VmbAPI::FeaturePtr m_LUTSaveFeature;
